...
function PanelsLayout(props: PanelsLayoutProps) {
  ...
  const handleDragging = (e: React.PointerEvent) => {
    ...
    var leftColumnLeft = leftColumnRect.left;
    var leftColumnRight = leftColumnRect.right;
    var draggingColumnLeft = draggingColumnRect.left;
    var draggingColumnRight = draggingColumnRect.right;
    ...
    const newColumnLayouts = columnLayouts.map(oldColumnLayout => {
      var currentColumnWidth = oldColumnLayout.overwriteWidth;
...
export type { PanelsLayoutProps, ColumnConfig };
